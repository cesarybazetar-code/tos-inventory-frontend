...
> = {
  admin:   ['counts', 'catalog', 'items', 'auto', 'settings', 'ocr', 'users', 'reports'],
  manager: ['counts', 'items', 'auto', 'ocr', 'reports'],
  counter: ['counts'],
  viewer:  ['counts'],
};
...
export default function App() {
  ...
  return (
    <Theme />
      ...
      <h1>TOS Inventory</h1>
      <TopNav tab={tab as any} setTab={(setTab as any)} allowedTabs={allowedTabs as any} />
